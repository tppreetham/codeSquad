# -*- coding: utf-8 -*-
"""gru1_0.2dropout.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CCf_Cz3BPeQjT7hSC1gUSuFWu_SRhqI3
"""
...
print(len(Imagedict))
print(Imagedict[Imagedict.keys()[0]])
...
for line in thefile:
	capp = line[:-1]
	capp = re.sub('[!@#$\']', '', capp)
	captions.append(capp)
	
print(captions[0])

print(Imagedict.keys()[0][:100])



print("length of captions: ",len(caps),"legth of images",len(Images),"..................................")
#index = np.loadtxt('imageindex.txt')



print('Number of images loaded:',len(Images))
#print(Images[len(Images)-1],caps[len(caps)-1])
captions_marked = mark_captions(caps)
...
#caps_markedwords = sentences_tolistt(captions_marked)

num_words = len(inttoword.keys())
#print wordtoint["ssss"]
#caps_markedwords = sentences_to_listt(captions_marked)
...
pickle_out = open("word2int.pickle","wb")
pickle.dump(wordtoint, pickle_out)
pickle_out.close()

pickle_out = open("int2word.pickle","wb")
pickle.dump(wordtoint, pickle_out)
pickle_out.close()
...
# np.savetxt("/content/drive/My Drive/flickr8k/transfer_values.txt",transfer_values,fmt="%d")
